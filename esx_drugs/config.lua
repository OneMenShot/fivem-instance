...
Config.CircleZones = {
	...
	--Chemicals
	ChemicalsField = {coords = vector3(817.46, -3192.84, 5.9), name = _U('blip_ChemicalsFarm'), color = 4, sprite = 310, radius = 0.0},
	ChemicalsConvertionMenu = {coords = vector3(3718.8, 4533.45, 21.67), name = _U('blip_ChemicalsProcessing'), color = 4, sprite = 310, radius = 0.0},
	...
	--LSD
	lsdProcessing = {coords = vector3(91.26, 3749.31, 40.77), name = _U('blip_lsdprocessing'),color = 48, sprite = 51, radius = 20.0},
	thionylchlorideProcessing = {coords = vector3(1903.98, 4922.70, 48.16), name = _U('blip_lsdprocessing'),color = 48, sprite = 51, radius = 2.0},
	
	--Heroin
	HeroinField = {coords = vector3(16.34, 6875.94, 12.64), name = _U('blip_heroinfield'), color = 25, sprite = 497, radius = 20},
	HeroinProcessing = {coords = vector3(723.3, 4190.2, 41.1), name = _U('blip_heroinprocessing'), color = 25, sprite = 497, radius = 1.0},

	--DrugDealer
	DrugDealer = {coords = vector3(-1172.02, -1571.98, 4.66), name = _U('blip_drugdealer'), color = 6, sprite = 378, radius = 1.0},
